  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background disabled:pointer-events-none disabled:opacity-50 select-none',
  {
    variants: {
      variant: {
        ...
        accent:
          'bg-lime text-primary-foreground hover:brightness-110 active:scale-[0.98] shadow-[0_8px_30px_hsl(var(--accent-lime)/0.18)]',
        orange:
          'bg-orange text-orange-foreground hover:brightness-110 active:scale-[0.98]',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90',
        outline:
          'border border-border bg-transparent text-foreground hover:bg-surface-3 hover:border-surface-4',
        secondary:
